...
**Welcome to the Amazon Prime clone App Deployment project! This project demonstrates how to deploy a Amazon Prime clone Clone Next.js application on Kubernetes cluster using modern DevOps tools, practices and following a DevSecOps approach.**
